...
/**
 * Generated class for the VendorAccountPhonePage page.
 *
...
@Component({
  selector: 'page-vendor-account-phone',
  templateUrl: 'vendor-account-phone.html',
})
export class VendorAccountPhonePage {
