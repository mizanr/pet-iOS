...
/**
 * Generated class for the EditBrakPage page.
 *
...
@Component({
  selector: 'page-edit-brak',
  templateUrl: 'edit-brak.html',
})
export class EditBrakPage {
feed_id:any;
ownerInfo:any = '';
info:any = '';
...
new_video:any;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EditBrakPage');
  }
   ...
   get_info(feed_id:any) {
    ...
    this.rest_api.postData(Data,'get_feed_detail').then((result:any) => {
      ...
      if(result.status == 1) {
        ...
        this.ownerInfo = this.info.users;
        this.autofildata();
      }
    })
  }
    ...
    update() {
      if(this.feedImage!='' || this.new_video !=''){
    	...
    	let Data = {
    		...
    		posted_pet:{"value":this.info.pet_id,"type":"NO"},
    		pet_id:{"value":this.info.pet_id,"type":"NO"},    		
